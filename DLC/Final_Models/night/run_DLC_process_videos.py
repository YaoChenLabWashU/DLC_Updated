...
with open('/storage1/fs1/yaochen/Active/DLC/Final_Models/night/temporary_remove.sh', 'rb') as file:
    script = file.read()
rc = call(script, shell=True)
print("------------- Temporary files removed ---------------------")

ProjectFolderName = '/storage1/fs1/yaochen/Active/DLC/Final_Models/night'
VideoType = 'mp4' 
